                    ...
                    <tr>
                        ...
                        <td>
                            <span id="entireUpdatePosition">
                                <button type="button" class="btn updatePosition" data-bs-toggle="modal"
                                    data-bs-target="#updatePosition{{ $position->position_code }}"><i
                                        class="fas fa-tools fa-lg" style="color: #FFD43B; margin-right: 1em;"></i></button>
                                <div class="modal fade" id="updatePosition{{ $position->position_code }}" tabindex="-1"
                                    aria-labelledby="updatePositionLabel{{ $position->position_code }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <strong>
                                                    <h3 class="modal-title"
                                                        id="updatePositionLabel{{ $position->position_code }}">Sửa chức vụ
                                                    </h3>
                                                </strong>
                                            ...
                                            <div class="modal-body">
                                                <form id="formUpdatePosition" method="post"
                                                    ...
                                                    @csrf
                                                    <div class="form-group" id="top-form">
                                                        <strong><label for="positionName{{ $position->position_code }}">Tên
                            ...
                            <span id="entireDeletePosition">
                                <button type="button" class="btn deletePosition" data-bs-toggle="modal"
                                    data-bs-target="#deletePosition{{ $position->position_code }}"><i
                                        class="fas fa-times fa-lg" style="color: #ff0000;"></i></button>
                                <div class="modal fade" id="deletePosition{{ $position->position_code }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <strong>
                                                    <h3 class="modal-title"
                                                        id="deletePositionLabel{{ $position->position_code }}">Xoá chức vụ
                                                    </h3>
                                                </strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Close</button>
                                                <a href="{{ route('manager.deletePosition', ['position_code' => $position['position_code']]) }}"><button type="button" class="btn btn-danger">Xoá</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
